...
function SamplePlatform(log, config, api) {
  ...
  this.requestServer = http.createServer(function(request, response) {
    ...
    if (request.url.startsWith("/add")) {
      ...
      console.log(queryURL.query.name);
      this.addAccessory();
      this.addAccessory(queryURL.query.name, "Lightbulb");
      // this.addAccessory("My Test Switch", "Switch");
...
SamplePlatform.prototype.addAccessory = function(accessoryName, accessoryType ) {
  ...
  if (!accessoryName) {
    accessoryName = "My Test Accessory"
  }
  ...
  // to Get List of Services look at /lib/gen/HomeKitTypes.js (hap-nodejs)
  //light
  console.log(accessoryType);
  // if (accessoryType == "Lightbulb"){
  ...
  // // Switch
  // if (accessoryType == "Switch"){
  //   newAccessory.addService(Service.Switch, "Test Switch")
  //   .getCharacteristic(Characteristic.On)
  //   .on('set', function(value, callback) {
  ...
  //   newAccessory.addService(Service.Outlet, "Test Outlet")
  //   .getCharacteristic(Characteristic.On)
  //   .on('set', function(value, callback) {
  ...
  //   newAccessory.addService(Service.Outlet, "Test MotionSensor")
  //   .getCharacteristic(Characteristic.On)
